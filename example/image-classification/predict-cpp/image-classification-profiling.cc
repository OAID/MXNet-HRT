...
int main(int argc, char* argv[]) {
    ...
    long t0 = tv[0].tv_sec * NANO_SEC_CONV + tv[0].tv_usec;
    long t1 = tv[1].tv_sec * NANO_SEC_CONV + tv[1].tv_usec;
    float total=0;
    total+=((double)t1 - t0) / NANO_SEC_CONV;
    printf("Total time: %f secs per forward\n",total/10);
